...
<h5>Nombre</h5>
<input name="txtName" type="text" class="txbx" value="Tu Nombre" /><br />
<h5>Email</h5>
<input type="hidden" name="emailto" value="<?php echo $webnus_options->webnus_contact_email(); ?>" />
<input name="txtEmail" type="text" class="txbx" value="Tu Correo Electronico" /><br />
<h5>Asunto</h5>
<input name="txtSubject" type="text" class="txbx" value="El motivo por el cual nos escribes" /><br />
<div class="erabox">
<h5>Mensaje</h5>
<textarea name="txtText" class="txbx era" ></textarea><br />
<input name="" type="button" class="sendbtn" value="Enviar" id="btnSend"/>
