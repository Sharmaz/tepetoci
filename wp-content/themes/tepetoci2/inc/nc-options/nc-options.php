...
function setup_framework_options() {
    ...
    $args['intro_text'] = __('<p>webnus theme options. all about theme option which can be edited is here. W/P/L/O/C/K/E/R/./C/O/M/</p>', WEBNUS_TEXT_DOMAIN);
    ...
    $sections[] = array(
        ...
        'desc' => __('<p class="description">Setup the general options of theme.</p>', 
            WEBNUS_TEXT_DOMAIN),
