...
?>
 <section id="headline">
    <div class="container">
      <h3><?php
					if ( is_day() ) :
						printf( __( '<small>Archivos Diarios:</small> %s', 'WEBNUS_TEXT_DOMAIN' ), get_the_date() );
					elseif ( is_month() ) :
						printf( __( '<small>Archivos Mensuales:</small> %s', 'WEBNUS_TEXT_DOMAIN' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'WEBNUS_TEXT_DOMAIN' ) ) );
					elseif ( is_year() ) :
						printf( __( '<small>Archivos Anuales:</small> %s', 'WEBNUS_TEXT_DOMAIN' ), get_the_date( _x( 'Y', 'yearly archives date format', 'WEBNUS_TEXT_DOMAIN' ) ) );
						
					elseif ( is_category() ):
						printf( __( '<small>Por Categoría:</small> %s', 'WEBNUS_TEXT_DOMAIN' ), single_cat_title( '', false ) );
					else :
