      ...
      <div id="tline-content">
		...
		?> <br>
          <div class="tline-ecxt">
			...
			<h6 class="blog-author">en <?php the_category(', ') ?> - por <?php the_author(); ?></h6>
			<?php endif; ?>
          </div><p>
          <?php 
          ...
          <div class="blog-com-sp"> <?php comments_popup_link('Sin comentarios &#187;', '1 Comentario &#187;', '% Comentarios &#187;'); ?></div>
        </article>
		<?php 
			$i++;
			endwhile;
