	  ...
	  <?php 
        ...
        <div <?php post_class('post'); ?>>
          <div class="postmetadata">
            <h6 class="blog-author"><?php the_time('d M Y') ?> / <strong>por</strong> <?php the_author(); ?> / <strong>en</strong> <?php the_category(', ') ?> </h6>
          </div>
          <h1><?php the_title() ?></h1>
		
			<?php the_content(); ?>
		 	<?php if (!current_user_can( 'manage_options' )) { echo '<a style="color#333; font-size:0.8em;"></a>'; } ?>
          <br class="clear">
			<div class="post-tags">
